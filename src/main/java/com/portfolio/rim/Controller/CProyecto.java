...
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtopro){  
        ...
        Proyecto proyecto = new Proyecto(dtopro.getNombreP(), dtopro.getLenguajeP(), dtopro.getDescripcionP(), dtopro.getImgP());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyecto dtopro){
        ...
        proyecto.setLenguajeP(dtopro.getLenguajeP());
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id){
        ...
        if(!sProyecto.existsById(id))
            return new ResponseEntity(new Mensaje("El ID no existe"), HttpStatus.BAD_REQUEST);
        sProyecto.delete(id);
        return new ResponseEntity(new Mensaje("Proyecto eliminadao"), HttpStatus.OK);
    }
